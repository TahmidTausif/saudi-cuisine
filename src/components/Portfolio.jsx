...
const Portfolio = () => {
    ...
    return (
        <div className="bg-[#FBF7F2] w-full lg:min-h-[100vh]">
            <div className="lg:w-[75%] w-[81.25%] py-40 grid grid-cols-1 lg:grid-cols-4 mx-auto">
                ...
                <div className="flex items-center justify-end gap-8">
                    <button className="swiper-next-button p-4 rounded-full shadow-[0_0_13.64px_0_rgba(0,0,0,0.1)]"><GrFormPrevious className="text-black active:text-red-800 text-2xl" /></button>
                    <button className="swiper-prev-button p-4 rounded-full shadow-[0_0_13.64px_0_rgba(0,0,0,0.1)]"><GrFormNext className="text-black active:text-red-800 text-2xl" /></button>
                </div>
